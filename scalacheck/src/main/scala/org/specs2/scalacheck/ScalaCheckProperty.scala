...
case class ScalaCheckFunction2[T1, T2, R](
  ...
  private implicit val (_,_) = (argInstances1.shrink,argInstances2.shrink)
...
case class ScalaCheckFunction3[T1, T2, T3, R](
  ...
  private implicit val (_,_,_) = (argInstances1.shrink,argInstances2.shrink,argInstances3.shrink)
...
case class ScalaCheckFunction4[T1, T2, T3, T4, R](
  ...
  private implicit val (_,_,_,_) = (argInstances1.shrink,argInstances2.shrink,argInstances3.shrink,argInstances4.shrink)
...
case class ScalaCheckFunction5[T1, T2, T3, T4, T5, R](
  ...
  private implicit val (_,_,_,_,_) = (argInstances1.shrink,argInstances2.shrink,argInstances3.shrink,argInstances4.shrink,argInstances5.shrink)
...
case class ScalaCheckFunction6[T1, T2, T3, T4, T5, T6, R](
  ...
  private implicit val (_,_,_,_,_,_) = (argInstances1.shrink,argInstances2.shrink,argInstances3.shrink,argInstances4.shrink,argInstances5.shrink,argInstances6.shrink)
...
case class ScalaCheckFunction7[T1, T2, T3, T4, T5, T6, T7, R](
  ...
  private implicit val (_,_,_,_,_,_,_) = (argInstances1.shrink,argInstances2.shrink,argInstances3.shrink,argInstances4.shrink,argInstances5.shrink,argInstances6.shrink,argInstances7.shrink)
...
case class ScalaCheckFunction8[T1, T2, T3, T4, T5, T6, T7, T8, R](
  ...
  private implicit val (_,_,_,_,_,_,_,_) = (argInstances1.shrink,argInstances2.shrink,argInstances3.shrink,argInstances4.shrink,argInstances5.shrink,argInstances6.shrink,argInstances7.shrink,argInstances8.shrink)
